...
import 'Loader.dart';
import 'PositionOptions.dart';
import 'PositionResponse.dart';
...
class WebViewElementState extends State<WebViewElement>
  ...
  void _geolocationClearWatch(int flutterGeolocationIndex) {
    ...
    String javascript = '''      function _flutterGeolocationResponse() {
        _flutterGeolocationSuccess[$flutterGeolocationIndex] = null;
        _flutterGeolocationError[$flutterGeolocationIndex] = null;
        return true;
      };
  ...
  void _geolocationResponse(
    ...
    if (positionResponse.position != null) {
      String javascript = '''        function _flutterGeolocationResponse() {
          _flutterGeolocationSuccess[$flutterGeolocationIndex]({
            coords: { 
              accuracy: ${positionResponse.position.accuracy}, 
              altitude: ${positionResponse.position.altitude}, 
            ...
            timestamp: ${positionResponse.position.timestamp!.millisecondsSinceEpoch}          });${!watcher
      ...
      if (await webViewController!.canGoBack()) {
        ...
        return showDialog(
          ...
          builder: (context) => AlertDialog(
            title: Text(I18n.current!.closeApp),
            content: Text(I18n.current!.sureCloseApp),
            actions: <Widget>[
              TextButton(
